...
public class AjaxTilesViewTests extends TestCase {
    ...
    private AjaxTiles21View ajaxTilesView;
	...
	servletContext.addInitParameter("org.apache.tiles.evaluator.el.ExpressionFactoryFactory",
		"org.springframework.js.ajax.tiles2.AjaxTilesViewTests$TestExpressionFactoryFactory");
	tc.setServletContext(servletContext);
	tc.afterPropertiesSet();

	ajaxTilesView = new AjaxTiles21View();
    }
	...
	TilesRequestContextFactory tilesRequestContextFactory = new ChainedTilesRequestContextFactory();
    ...
    public static class TestExpressionFactoryFactory implements ExpressionFactoryFactory {

	public ExpressionFactory getExpressionFactory() {
	    return DefaultExpressionFactoryUtils.createExpressionFactory();
	}
