...
insert into Booking (beds, checkinDate, checkoutDate, creditCard, creditCardExpiryMonth, creditCardExpiryYear, creditCardName, hotel_id, smoking, user_username, id) values (1, '2009-03-19', '2009-03-20', '1234123412341234', 0, 0, 'foo', 5, false, 'jeremy', 10)
insert into Booking (beds, checkinDate, checkoutDate, creditCard, creditCardExpiryMonth, creditCardExpiryYear, creditCardName, hotel_id, smoking, user_username, id) values (1, '2009-03-22', '2009-03-27', '1234123412341234', 0, 0, 'foo', 21, false, 'jeremy', 101)
insert into Booking (beds, checkinDate, checkoutDate, creditCard, creditCardExpiryMonth, creditCardExpiryYear, creditCardName, hotel_id, smoking, user_username, id) values (1, '2009-04-15', '2009-04-22', '1234123412341234', 0, 0, 'foo', 15, false, 'jeremy', 299)