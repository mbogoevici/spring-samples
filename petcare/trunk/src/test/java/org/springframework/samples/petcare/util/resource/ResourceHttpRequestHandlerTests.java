package org.springframework.samples.petcare.util.resource;
...
public class ResourceHttpRequestHandlerTests {
	...
	@Before
	public void setUp() {
		handler = new ResourceHttpRequestHandler(new ClassPathResource("resources/", getClass()));
	}
	
	@Test
	public void getResource() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest();
		request.setRequestURI("/app/resources/foo.css");
		...
		assertEquals(response.getHeader("Last-Modified"), new ClassPathResource("resources/foo.css", getClass()).getFile().lastModified());
	...
	public void getResourceBundle() throws Exception {
		...
		assertEquals("max-age=31556926", response.getHeader("Cache-Control"));
		assertTrue(response.containsHeader("Last-Modified"));
		assertEquals(response.getHeader("Last-Modified"), new ClassPathResource("resources/bar.css", getClass()).getFile().lastModified());
	...
	public void getResourceFromSubDirectory() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest();
		request.setRequestURI("/app/resources/js/foo.js");
	...
	public void notModified() throws Exception {
		...
		request.setRequestURI("/app/resources/foo.css");
		request.setAttribute(HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, "/foo.css");
		request.addHeader("If-Modified-Since", new ClassPathResource("resources/foo.css", getClass()).getFile().lastModified());
		request.setMethod("GET");
		MockHttpServletResponse response = new MockHttpServletResponse();
		handler.handleRequest(request, response);
	...
	public void modified() throws Exception {
		...
		request.setRequestURI("/app/resources/foo.css");
		request.setAttribute(HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, "/foo.css");
		request.addHeader("If-Modified-Since", new ClassPathResource("resources/foo.css", getClass()).getFile().lastModified() - 1);
		request.setMethod("GET");
		MockHttpServletResponse response = new MockHttpServletResponse();
		handler.handleRequest(request, response);
	...
	public void directory() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest();
		request.setRequestURI("/app/resources/js/");
	...
	public void missingResourcePath() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest();
		request.setRequestURI("/app/resources");
	...
	public void resourceNotFound() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest();
		request.setRequestURI("/app/resources/not-there.css");
